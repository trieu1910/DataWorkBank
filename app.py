...
st.error(f"**Nói đơn giản:** Người dùng AI hàng ngày nhưng trong lòng **sợ AI** thì chỉ sẵn sàng giao việc ở mức {grp_high_use_fear:.2f}/5 — "
...
st.warning(f"**Nói đơn giản:** Ai sợ mất quyền kiểm soát thì ít chịu giao việc cho AI hơn ({ctrl_true_desire:.2f} vs {ctrl_false_desire:.2f}). "
...
st.info(f"**Nói đơn giản:** Nhóm dùng AI ra quyết định hàng ngày vừa **muốn AI giúp** ({dec_daily_desire:.2f}/5) "
...
st.error(f"**Nói đơn giản:** Người đi làm 6-10 năm là nhóm **sợ AI nhất**: "
...
st.error(f"**Nói đơn giản:** Những việc mà con người **giữ lại không giao cho AI** (cột xanh) lại đòi hỏi "
